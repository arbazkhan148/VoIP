...
<body class="host_version">
    ...
    <img src="{{asset('assets/images/logo2-hosting.png')}}" alt="" style="max-height: 90px; width: 140px;" />
</a>
				...
				<div class="collapse navbar-collapse" id="navbars-host">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="dropdown-a" data-toggle="dropdown">Registration</a>
							<div class="dropdown-menu" aria-labelledby="dropdown-a">
...
<!--
    ...
    @yield('content')
    <link rel="stylesheet"href="{{asset('assets/https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css')}}">
 <footer class="footer">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="footer-distributed">
                <div class="footer-left">
                    <p class="footer-company-name">All Rights Reserved. &copy; 2025 <a href="#">Future Next</a><!--  Developed and Maintained By : <a href="https://html.design/">XYZ</a> --></p>
                </div>
