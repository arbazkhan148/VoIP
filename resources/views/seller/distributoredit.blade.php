        ...
        <section class="section">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Distributor Edit Form</h5>

                            <!-- No Labels Form -->
                            <form class="row g-3" action="{{ route('seller.distributorupdate',[$distributor->id]) }}" method="post"> @csrf
                                <div class="col-md-6">
                                    <input type="text" class="form-control" placeholder="First Name" name="first_name" value="{{$distributor->first_name}}"
                                        required>
                                </div>
                                <div class="col-md-6">
                                    <input type="text" class="form-control" placeholder="Last Name" name="last_name" value="{{$distributor->last_name}}"
                                        required>
                                </div>
                                <div class="col-md-6">
                                    <input type="text" class="form-control" placeholder="Phone Number" name="phone" value="{{$distributor->phone}}"
                                        required>
                                </div>
                                <div class="col-md-6">
                                    <input type="email" class="form-control" placeholder="Email" name="email" required value="{{$distributor->email}}">
                                    @error('email')
