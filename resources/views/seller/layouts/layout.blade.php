...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{url('seller/profile')}}">
                    <i class="bi bi-person"></i>
                    <span>Profile</span>
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('seller/register') }}">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{url('seller/contact')}}">
